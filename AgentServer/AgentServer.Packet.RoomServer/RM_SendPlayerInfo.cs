...
{
	public sealed class RM_SendPlayerInfo : NetPacket
	{
		public RM_SendPlayerInfo(Account User, RoomSettings roomsetting, int FarmUniqueNum, byte last)
		{
			ns.WriteOP(RMProtocol.RM_CreateRoom_REQ);
