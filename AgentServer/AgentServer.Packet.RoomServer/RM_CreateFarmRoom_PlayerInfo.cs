...
{
	public sealed class RM_CreateFarmRoom_PlayerInfo : NetPacket
	{
		public RM_CreateFarmRoom_PlayerInfo(Account User, RoomSettings roomsetting, int FarmUniqueNum, byte last)
		{
			ns.WriteOP(RMProtocol.RM_EnterFarm_PlayerInfo_REQ);
