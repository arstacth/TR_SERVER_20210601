...
{
	public sealed class Room_UPDATE_ITEM_ONOFF_INFO : NetPacket
	{
		public Room_UPDATE_ITEM_ONOFF_INFO(byte pos, int itemnum, int OnOffType, int Position, bool bOnOff, NetItemInfo offitem, NetItemInfo onitem, byte last)
		{
