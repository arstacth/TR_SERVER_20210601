...
{
	public sealed class GetSendListOK : NetPacket
	{
		public GetSendListOK(int messageType, int UserNum, short iPage, short iList, short iRequestCount, byte last)
		{
			...
			using (MySqlConnection mySqlConnection = new MySqlConnection(Conf.Connstr))
			{
				...
				mySqlCommand.CommandText = "usp_messageBoxSendList";
