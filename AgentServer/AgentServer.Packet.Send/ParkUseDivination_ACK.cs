...
{
	public sealed class ParkUseDivination_ACK : NetPacket
	{
		public ParkUseDivination_ACK(ExtraAbilityItemInfo exItemInfo, ExtraAbilityItemAttrInfo exItemAttrInfo, byte last)
		{
		...
		public ParkUseDivination_ACK(Account User, int divinationType, Dictionary<int, ExtraAbilityInfo> m_ExtraAbilities, byte last)
		{
			ns.WriteOP(Opcodes.eServer_Divination_GET_RESULT_ASK);
			ns.Write(0);
