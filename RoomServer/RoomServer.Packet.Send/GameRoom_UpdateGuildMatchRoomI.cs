...
{
	public sealed class GameRoom_UpdateGuildMatchRoomInfo : NetPacket
	{
		public GameRoom_UpdateGuildMatchRoomInfo(NormalRoom room, byte last)
		{
			ns.WriteOP(Opcodes.eServer_GUILDMATCH_MY_PARTYINFO_ACK);
			ns.Write((byte)1);
			ns.Write(2);
